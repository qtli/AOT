...
parser.add_argument("--test", type=str2bool, nargs='?', const=True, default=False, help="activate nice mode")
...
parser.add_argument("--attn_analysis", action="store_true")
...
parser.add_argument("--early_t", type=int, default=13000)
...
attn_analysis = arg.attn_analysis
